...
<nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav" >
    <div class="container">
      ...
      <a class="navbar-brand js-scroll-trigger" href="#" style="margin-top: 10px;margin-left:-65px;font-family: 'IBM Plex Sans', sans-serif;"><h4><i class="fa fa-user-plus" aria-hidden="true"></i>&nbsp DAFFODIL INTERNATIONALS HOSPITALS</h4></a>
...
<div class="container register" style="font-family: 'IBM Plex Sans', sans-serif;">
                <div class="row">
                    <div class="col-md-3 register-left" style="margin-top: 10%;right: 5%">
                        <img src="images/hospital_logo.png.png" alt=""style="width: 200px; height: auto;"/>
                        <h3>Welcome Daffodil Hospital</h3>
                       
                    </div>
                    <div class="col-md-9 register-right" style="margin-top: 80px;left: 80px;">
