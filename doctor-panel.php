...
<html lang="en">
  ...
  <a class="navbar-brand" href="#"><i class="fa fa-user-plus" aria-hidden="true"></i> DAFFODIL INTERNATIONALS HOSPITALS </a>
...
.text-primary {
  ...
  <body style="padding-top:50px;">
   <div class="container-fluid" style="margin-top:50px;">
    <h3 style = "margin-left: 40%; padding-bottom: 20px;font-family:'IBM Plex Sans', sans-serif;"> Welcome Daffodil Hospital &nbsp<?php echo $_SESSION['dname'] ?>  </h3>
    <div class="row">
